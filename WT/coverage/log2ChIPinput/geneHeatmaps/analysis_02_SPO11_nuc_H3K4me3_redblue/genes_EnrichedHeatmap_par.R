...
plotDir <- "/projects/ajt200/BAM_masters/SPO11-oligo/WT/coverage/log2ChIPinput/geneHeatmaps/analysis_02_SPO11_nuc_H3K4me3_redblue/plots/"
...
#
#  col_fun1 <- colorRamp2(quantile(mat1_smoothed, c(0.5, 0.95)), c("blue", "red"))
...
geneHeatmapOrder <- function(h, i) {
  ...
  col_fun1 <- colorRamp2(quantile(mat2_smoothed, c(0.5, 0.95)), c("blue", "red"))
