...
for i in WT_SPO11-oligo_RPI3 WT_SPO11-oligo_RPI8
do
  paste -d "\t" ${i}_norm_allchrs_coverage_coord_tab.bed /projects/ajt200/BAM_masters/WT_nakedDNA/single_trim50/R1/coverage/WT_nakedDNA_R1_norm_allchrs_coverage_coord_tab.bed > ${i}_nakedDNA_R1_norm_allchrs_coverage_coord_tab_tmp.bed
done

for i in WT_SPO11-oligo_RPI3_nakedDNA_R1 WT_SPO11-oligo_RPI8_nakedDNA_R1
do
