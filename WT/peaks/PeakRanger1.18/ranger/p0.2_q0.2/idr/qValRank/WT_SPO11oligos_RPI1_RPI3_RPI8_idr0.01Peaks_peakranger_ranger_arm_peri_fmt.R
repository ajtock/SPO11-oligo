...
# Definitions
peakDir <- "/projects/ajt200/BAM_masters/SPO11-oligo/WT/SPO11_peaks/PeakRanger1.18/ranger/p0.2_q0.2/idr/qValRank/"
pericenStart <- c(11330001, 990001, 10200001, 990001, 8890001)
pericenEnd <- c(18480000, 7540000, 16860000, 6850000, 15650000)

rangerPeaks <- read.table(file = paste0(peakDir, "WT_SPO11oligos_RPI1_RPI3_RPI8_idrValues_qValRank_idr0.01.narrowPeak"))
...
write.table(rangerPeaks.arms, file = paste0(peakDir, "rangerPeaks.arms.RPI1_RPI3_RPI8_idr0.01.txt"))
write.table(rangerPeaks.peri, file = paste0(peakDir, "rangerPeaks.peri.RPI1_RPI3_RPI8_idr0.01.txt"))
...
## remove peaks < 25 bp
#armrangerPeaksGR <- armrangerPeaksGR[width(armrangerPeaksGR) >= 25]
...
## remove peaks < 25 bp
#perirangerPeaksGR <- perirangerPeaksGR[width(perirangerPeaksGR) >= 25]
save(armrangerPeaksGR, file = paste0(peakDir, "armrangerPeaksGR_RPI1_RPI3_RPI8_idr0.01.RData"))
save(perirangerPeaksGR, file = paste0(peakDir, "perirangerPeaksGR_RPI1_RPI3_RPI8_idr0.01.RData"))
...
save(armrangerPeaksGRmerge, file = paste0(peakDir, "armrangerPeaksGRmerge_RPI1_RPI3_RPI8_idr0.01.RData"))
save(perirangerPeaksGRmerge, file = paste0(peakDir, "perirangerPeaksGRmerge_RPI1_RPI3_RPI8_idr0.01.RData"))
