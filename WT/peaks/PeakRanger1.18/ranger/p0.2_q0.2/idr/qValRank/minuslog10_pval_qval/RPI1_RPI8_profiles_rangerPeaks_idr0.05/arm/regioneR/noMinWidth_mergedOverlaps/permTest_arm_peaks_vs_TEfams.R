...
save(ptPeaksTEsDNAPerChrom,
     file = paste0(outDir,
                   "permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_vs_TEsDNA.RData"))
...
write.table(ptPeaksTEsDNAPerChromDataFrame,
            file = paste0(outDir,
                          "permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_vs_TEsDNA_DataFrame.txt"),
            sep = "\t", row.names = F)

# plot graphical summaries of results
for(i in 1:length(ptPeaksTEsDNAPerChrom)) {
  pdf(file = paste0(plotDir, DNAfamNames[i], "_permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_perChrom.pdf"), width = 10, height = 7)
  plot(ptPeaksTEsDNAPerChrom[[i]], main = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i]), xlab = "Number of overlaps", ylab = "Density")
  dev.off()
  ...
  pdf(file = paste0(plotDir, DNAfamNames[i], "_localZscore_permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_w1kb_s50bp_w10kb_s500bp_w", win ,"kb_s", step, "bp_perChrom.pdf"))
  par(mar=c(5.1, 4.1, 4.1, 2.1))
  plot(lz_1kb, main = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i], " (1-kb shift)"))
  mtext(side = 3, at = 2, text = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i], " (1-kb shift)"))
  plot(lz_10kb, main = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i], " (10-kb shift)"))
  mtext(side = 3, at = 2, text = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i], " (10-kb shift)"))
  plot(lz_custom, main = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i], " (~", win, "-kb shift)"))
  mtext(side = 3, at = 2, text = paste0("SPO11oligo hotspots arm vs ", DNAfamNames[i], " (~", win, "-kb shift)"))
  dev.off()
}
...
save(ptPeaksTEsRNAPerChrom,
     file = paste0(outDir,
                   "permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_vs_TEsRNA.RData"))
...
write.table(ptPeaksTEsRNAPerChromDataFrame,
            file = paste0(outDir,
                          "permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_vs_TEsRNA_DataFrame.txt"),
            sep = "\t", row.names = F)

# plot graphical summaries of results
for(i in 1:length(ptPeaksTEsRNAPerChrom)) {
  pdf(file = paste0(plotDir, RNAfamNames[i], "_permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_perChrom.pdf"), width = 10, height = 7)
  plot(ptPeaksTEsRNAPerChrom[[i]], main = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i]), xlab = "Number of overlaps", ylab = "Density")
  dev.off()
  ...
  win <- as.character(round((10*mean(width(peaksGR)))/1000))
  step <- as.character(round(mean(width(peaksGR))/2))
  pdf(file = paste0(plotDir, RNAfamNames[i], "_localZscore_permTest_", as.character(perms), "perms_SPO11oligo_hotspots_arm_w1kb_s50bp_w10kb_s500bp_w", win ,"kb_s", step, "bp_perChrom.pdf"))
  par(mar=c(5.1, 4.1, 4.1, 2.1))
  plot(lz_1kb, main = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i], " (1-kb shift)"))
  mtext(side = 3, at = 2, text = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i], " (1-kb shift)"))
  plot(lz_10kb, main = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i], " (10-kb shift)"))
  mtext(side = 3, at = 2, text = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i], " (10-kb shift)"))
  plot(lz_custom, main = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i], " (~", win, "-kb shift)"))
  mtext(side = 3, at = 2, text = paste0("SPO11oligo hotspots arm vs ", RNAfamNames[i], " (~", win, "-kb shift)"))
  dev.off()
}
