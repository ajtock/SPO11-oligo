...
outDir <- "/projects/ajt200/BAM_masters/SPO11-oligo/WT/peaks/PeakRanger1.18/ranger/p0.2_q0.2/idr/qValRank/minuslog10_pval_qval/RPI1_RPI8_profiles_rangerPeaks_idr0.05/pericentromeres/base_composition_REC8paper/"
plotDir <- "/projects/ajt200/BAM_masters/SPO11-oligo/WT/peaks/PeakRanger1.18/ranger/p0.2_q0.2/idr/qValRank/minuslog10_pval_qval/RPI1_RPI8_profiles_rangerPeaks_idr0.05/pericentromeres/base_composition_REC8paper/plots/"
...
targetsGR <- perirangerPeaksGRmerge
print("***********peaks***********")
print(targetsGR)
...
pdf(paste0(plotDir, "SPO11_1_oligo_peripeak_base_relative_frequency_diffYaxes_v080618.pdf"), height = 5, width = 6)
par(mfrow = c(2, 2))
...
mergeBaseFreqPlotDiffY(at.coords = target.ATfreq, gc.coords = target.GCfreq,
                       ...
                       mainTitle1 = "Pericentromeric SPO11-1-oligo hotspots", mainTitle2 = "Pericentromeric random loci")
...
pdf(paste0(plotDir, "SPO11_1_oligo_peripeak_base_relative_frequency_v080618.pdf"), height = 5, width = 6)
par(mfrow = c(2, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
flankSize <- 2000
...
pdf(paste0(plotDir, "SPO11_1_oligo_peripeak_base_relative_frequency_AT_and_GC_diffYlims_v080618.pdf"), height = 10, width = 6)
par(mfrow = c(4, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
flankSize <- 2000
