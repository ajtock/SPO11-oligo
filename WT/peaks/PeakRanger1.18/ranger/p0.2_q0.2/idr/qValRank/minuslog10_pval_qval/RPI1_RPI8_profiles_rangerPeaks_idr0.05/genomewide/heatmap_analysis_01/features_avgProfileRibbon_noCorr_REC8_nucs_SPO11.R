...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_noCorr_REC8_nucs_SPO11.R SPO11oligo_hotspots 'SPO11-1 hotspots' 2000 2kb '2 kb' 20 20bp 'REC8_HA_Rep2,MNase,SPO11_1_oligos_RPI1' 'REC8-HA,Nucleosomes,SPO11-1' 'red,purple4,dodgerblue2' '0.02,0.94'
