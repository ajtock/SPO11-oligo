...
rangerPeaks <- read.table(file = paste0(peakDir, "WT_SPO11oligos_RPI1_RPI3_idrValues_qValRank_idr0.05.narrowPeak"))
...
write.table(rangerPeaks.arms, file = paste0(peakDir, "rangerPeaks.arms.RPI1_RPI3_idr0.05.txt"))
write.table(rangerPeaks.peri, file = paste0(peakDir, "rangerPeaks.peri.RPI1_RPI3_idr0.05.txt"))
...
save(armrangerPeaksGR, file = paste0(peakDir, "armrangerPeaksGR_RPI1_RPI3_idr0.05.RData"))
save(perirangerPeaksGR, file = paste0(peakDir, "perirangerPeaksGR_RPI1_RPI3_idr0.05.RData"))
...
save(armrangerPeaksGRmerge, file = paste0(peakDir, "armrangerPeaksGRmerge_RPI1_RPI3_idr0.05.RData"))
save(perirangerPeaksGRmerge, file = paste0(peakDir, "perirangerPeaksGRmerge_RPI1_RPI3_idr0.05.RData"))
