...
do
  ...
  awk 'BEGIN {OFS="\t"}; {$4 = "."; $5 = "."; $6 = "."; $7 = "."; $10 = $10-$2; print}' WT_SPO11oligos_RPI${i}_peaks_peakranger_ranger_p0.2_q0.2_noHead_tmp3 > WT_SPO11oligos_RPI${i}_peaks_peakranger_ranger_p0.2_q0.2_rfmtSH
